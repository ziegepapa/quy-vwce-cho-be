-- Ordered initial schema baseline.
-- This file is the migration-equivalent of the historical schema.sql and is
-- intentionally kept separate from 002 so a fresh controlled Supabase
-- environment can apply the repository's database contract in order.
